...
import 'package:jobapp/src/common_widgets/first_screen/navigate2.dart';
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              Container(
                height: 400,
                child: Image.asset("assets/images/back_girl.png"),
              ),
              Container(
                height: 280,
                width: 290,
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) => Nevg2()));
                      },
                      child: Container(
                        height: 40,
                        width: 90,
